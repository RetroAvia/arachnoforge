...
function SafeCityIllustration() {
  return (
    <svg viewBox="0 0 120 120" className="w-full h-full">
      ...
      <path d="M18 95h84" stroke="rgb(var(--af-refuel-rgb) / 0.35)" strokeWidth="2" />
    </svg>
  );
}
...
function EmptyTreeIllustration() {
  return (
    <svg viewBox="0 0 120 120" className="w-full h-full">
      ...
      <path d="M60 38v14" stroke="rgb(var(--af-refuel-rgb) / 0.35)" strokeWidth="2" />
      <path d="M36 52h48" stroke="rgb(var(--af-refuel-rgb) / 0.35)" strokeWidth="2" />
      <path d="M36 52v10M84 52v10M60 52v10" stroke="rgb(var(--af-refuel-rgb) / 0.35)" strokeWidth="2" />
...
function EmptyLogIllustration() {
  return (
    <svg viewBox="0 0 120 120" className="w-full h-full">
      <rect x="26" y="18" width="68" height="86" rx="6" fill="none" stroke="rgb(var(--af-refuel-rgb) / 0.35)" strokeWidth="2.5" />
